...
const FrameCom = () => {
  ...
  //   setInputValue(value)
  //   value === item_code ? (setCount_value(count_value + 1), setCount(count + 1)) : null
                ...
                .map((filteredRow, index) => (
                  <div key={index} style={{ display: 'flex', alignItems: 'center' }}>
                    ...
                    <TextField
                      ...
                      disabled={Math.max(filteredRow.frame_plan_qty - count - filteredRow.frame_prod_qty, 0) === 0}
                    />
                  </div>
                ))
            ) : (
              ...
              busPlans
                ...
                .map((rowData, index) => (
                  <img
                    key={index}
                    alt='diversitech'
                    style={{ cursor: 'pointer', maxWidth: '100%', height: 'auto' }} // Apply responsive styles here
