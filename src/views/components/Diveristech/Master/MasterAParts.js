...
//                     </TableCell>
//                     <TableCell align='right'>
//                       <Button variant='contained' color='secondary' onClick={() => setUpdateState(row.PartNo)}>
//                         Update
//                       </Button>
//                     </TableCell>
//                     <TableCell align='right'>
...
const MasterAParts = () => {
  ...
  useEffect(() => {
    // Make an API request here to fetch the data
    // For example, fetch('https://example-api.com/api/data')
    // Replace the URL with the actual API endpoint
    // Then update the 'rows' state with the fetched data
    // For simplicity, I'll set the rows with mock data here:
    setRows([
      createData('S100F01039', 'Hex Bolt M8x20mmL Trivalent Plating For SCB Plywood', 50, '/image/SeatsAssembly/1.png')

      // Add more objects here depending on the API response
    ])
  }, [])
